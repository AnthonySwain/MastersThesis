#This file is solely for adding uncertantity to the detector measurements to represent a more lifelike detector
...
def top_hat(width,size):
    ...
    noise = np.random.uniform(low = -width/2, high = width/2, size=size)
    return(noise)
